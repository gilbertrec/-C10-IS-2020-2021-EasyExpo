...
<div id="wrap">
    ...
    <section class="sub-bnr" data-stellar-background-ratio="0.5">
        <div class="position-center-center">
            <div class="container">
                <h4>NOME FORNITORE ${nome.fornitore}</h4>
                    ...
                    <div class="col-md-3">
                        <div class="item">
                            ...
                            <div class="item-img"> <img class="img-1" src="images/product-2-1.jpg" alt="" > <img class="img-2" src="images/product-2.jpg" alt="" >
                                ...
                                <div class="overlay">
                                    <div class="position-center-center">
                                        <div class="inn"><a href="images/product-2-1.jpg" data-lighter><i class="icon-magnifier"></i><a href="EliminaProdottoServlet"><i class="icon-trash"></i><a href="ModificaProdottoServlet"><i class="icon-pencil"></i></a></div>
                                    </div>
                                </div>
                            </div>
                            <!-- Item Name -->
