                    ...
                    <div class="cart-ship-info">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <a href="RegistrazioneFornitore" class="btn"
                                   style="margin-top: 20px; margin-right: 20px">REGISTRATI COME FORNITORE</a>
                                <!-- Registrati come cliente -->
                                <a href="RegistrazioneCliente" class="btn" style="margin-top: 20px; margin-right: 20px">REGISTRATI
                                    COME CLIENTE</a>
                            </div>
                        </div>
                    </div>
