                    ...
                    <div class="col-md-9">
                        ...
                        <article>
                            ...
                            <div class="post-tittle left"> <a href="#." class="tittle">${richiesta.titolo}</a>
                                <!-- Post Info -->
                                <span><i class="primary-color icon-user"></i> by admin</span> <span><i class="primary-color icon-calendar"></i> ${preventivo.dataPreventivo}</span></div>
                            ...
                            <div class="text-left">
                                ...
                                <div class="admin-info">
                                    ...
                                    <div class="media-body">
                                        <h6>${clifor.nome} ${clifor.cognome} <span>Fornitore</span></h6>
