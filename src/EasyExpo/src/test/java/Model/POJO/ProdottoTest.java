...
class ProdottoTest {
  ...
  void setUp() {
    prodotto =
        new Prodotto(1, "012345690", "Cassa", "Cassa audio", Prodotto.Tipo.ATTREZZATURA, 5, 50,
            "foto");
  }
  ...
  @Test
  void getTipo() {
    assertEquals(Prodotto.Tipo.ATTREZZATURA, prodotto.getTipo());
  }

  @Test
  void setTipo() {
    prodotto.setTipo(Prodotto.Tipo.SERVIZIO);
    assertEquals(Prodotto.Tipo.SERVIZIO, prodotto.getTipo());
  }
